                                    ...
                                    <?php if ($records != FALSE): ?>
                                        <?php foreach ($records as $key => $record): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo show_date_with_format($record->tgl_kegiatan,"d-m-Y H:i:s","Y-m-d H:i:s") ?>
                                                </td>
                                                <td>
                                                    <a  href="<?php echo base_url("back_end/ab_list_finger_kegiatan/index") . "/" . $record->id_kegiatan; ?>"><?php echo beautify_str($record->nama_kegiatan) ?></a>
                                                </td>
                                                <td>
