                                        ...
                                        <?php foreach ($records as $key => $record): ?>
                                            <tr>
                                                <td>
                                                 ...
                                                 <td>
                                                    <?php echo beautify_str($record->id_peg) ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <a class="btn btn-default" href="<?php echo base_url("back_end/" . $active_modul . "/detail") . "/" . $record->id_peg; ?>">Ubah</a>
                                                        <a class="btn btn-default btn-hapus-row" href="javascript:void(0);" rel="<?php echo base_url("back_end/" . $active_modul . "/delete") . "/" . $record->id_peg; ?>">Hapus</a>
                                                    </div>
                                                </td>
                                            </tr>
