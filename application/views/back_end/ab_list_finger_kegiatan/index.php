    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="block">
                    <h5> Nama Kegiatan : <?php echo $detail_kegiatan->nama_kegiatan; ?><br /></h5>
                    <h5>Tanggal Kegiatan: <?php echo $detail_kegiatan->tgl_kegiatan; ?><br /></h5>
                    <h5>Lokasi : <?php echo $detail_kegiatan->lokasi_mesin; ?><br /></h5>
                ...
                <div class="block">
                    ...
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo base_url('back_end/' . $active_modul . '/detail')."/".($detail_kegiatan ? $detail_kegiatan->id_kegiatan : 0); ?>" class="btn btn-success btn-block">
